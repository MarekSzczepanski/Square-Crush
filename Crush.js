class Crush {
    ...
    /* a() {
        for (let i=0; i<25; i++) {
            if (arrAllSquares[i].classList.contains("transitionSquare")) {
                arrAllSquares[i].style.backgroundColor = "white";
                arrAllSquares[i+5].style.backgroundColor = "white";
                arrAllSquares[i+10].style.backgroundColor = "white";
            }
        }
    }  */
